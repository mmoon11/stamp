...
export default function Itinerary() {
  ...
  const [sights, setSights] = useState<DocumentData>();
  ...
  const sightsDocRef = locationID
    ? doc(itinerariesCollectionRef, locationID)
    : null;

  async function getSights() {
    if (sightsDocRef) {
      const docSnap = await getDoc(sightsDocRef);
      if (docSnap.exists()) {
        setSights(docSnap.data().sights);
      } else {
        console.log("No such document!");
      }
    }
